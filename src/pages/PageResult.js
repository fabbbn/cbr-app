...
export default class PageResult extends React.Component {
    ...
    componentDidMount() {
        // fetch the data
        // const meta_url = ''
        const data_url = 'localhost:8000/generate-data/document/1';
        const search_url = ''
    }
    render() {
        return (
...
//                                 <td>{res_submit.proposal_title}</td>
//                             </tr>
//                             <tr className="align-top">
//                                 <th>Nama Penulis</th>
//                                 <td>{res_submit.proposal_writer}</td>
//                             </tr>
//                             <tr className="align-top">
//                                 <th>Tahun Proposal</th>
//                                 <td>{res_submit.proposal_year}</td>
//                             </tr>
//                             <tr className="align-top">
//                                 <th>Alamat Email Ketua Tim</th>
//                                 <td><a className="m-0 p-0" href={"mailto:"+res_submit.proposal_email}>{res_submit.proposal_email}</a></td>
//                             </tr>
//                             <tr className="align-top">
//                                 <th>SINTA ID Ketua Tim</th>
//                                 <td>{res_submit.proposal_sintaid}</td>
//                             </tr>
//                             <tr className="align-top">
//                                 <th>Jenis Ajuan</th>
//                                 <td>{res_submit.proposal_type}</td>
//                             </tr>
//                             <tr className="align-top">
//                                 <th >Dokumen Terunggah</th>
//                                 <td class="p-2 row justify-content-left">
//                                     <a className="m-0 col-6" as={Button} variant="link" href={"http://localhost:8000/download/"+res_submit.proposal_doc_link} download>Unduh Dokumen</a>
//                                 </td>
//                             </tr>
//                         </Table>
//                     </StyledContainer>
...
//                         <ol>
//                             {res_data.result.doc_parts.map((part) => (
//                                 <StyledContainer>
...
//                         <ol>
//                             {res_data.result.doc_pre_process.map((step) => (
//                                 <StyledContainer>
